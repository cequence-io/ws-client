...
/**
 * Class to track the current context during JSON parsing. This helps manage special cases like
 * missing quotes in keys or values.
 */
class JsonContext {
   ...
   * @return
   *   The current context value, if any.
   */
