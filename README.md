# WS Client (Cequence)
[![version](https://img.shields.io/badge/version-0.5.5-green.svg)](https://cequence.io) [![License](https://img.shields.io/badge/License-MIT-lightgrey.svg)](https://opensource.org/licenses/MIT) [![Twitter Follow](https://img.shields.io/twitter/follow/cequence_io?style=social)](https://twitter.com/0xbnd)
...
```
"io.cequence" %% "ws-client-play"" % "0.5.5"
```
